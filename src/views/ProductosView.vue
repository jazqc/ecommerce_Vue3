    ...
    <v-container fluid>
      ...
      <v-row dense>
        ...
        <v-card align="center">
            <v-img
              :src="product.img"
              class="align-end card-image mx-auto"
              gradient="to bottom, rgba(0,0,0,.1), rgba(0,0,0,.5)"
              cover

            >
            </v-img>
            <v-card-title class="text-deep-purple-darken-4 font-weight-bold text-center">{{product.title}}</v-card-title>
            <v-card-subtitle class="text-h6 text-black font-weight-bold text-center">${{ product.price }}</v-card-subtitle>
            ...
            <v-card-actions>
              ...
              <v-btn size="large" color="surface-variant" variant="text" icon="mdi-cart-plus"></v-btn>
            </v-card-actions>
          </v-card>
        </v-item>
